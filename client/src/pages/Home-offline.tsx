...
export default function Home() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate success - no network requests
    setTimeout(() => {
      setIsSuccess(true);
      ...
      const waitlist = JSON.parse(localStorage.getItem('gensparx_waitlist') || '[]');
      waitlist.push({ ...formData, timestamp: new Date().toISOString() });
      localStorage.setItem('gensparx_waitlist', JSON.stringify(waitlist));
